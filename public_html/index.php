		...
		<nav class="navbar fixed-top navbar-default navbar-expand-md navbar-light bg-light" id="top-of-page">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="./images/chelsea-david-resume.pdf">Resume</a>
						</li>
						<li class="nav-item">
							<a href="https://github.com/chelseadavid" target="_blank" class="nav-link"><i class="fab fa-github" aria-hidden="true"></i></a>
						</li>
						<li class="nav-item">
							<a href="https://www.linkedin.com/in/chelseadavid36/" target="_blank" class="nav-link"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a>
						</li>
						<li class="nav-item">
